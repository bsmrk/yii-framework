...
EOD;
	...
	{
		if(!isset($args[0]))
			$args[0]='htdocs/index.php';
		$entryScript=isset($args[0]) ? $args[0] : 'htdocs/index.php';
		...
		if(is_array($config))
		{
			...
			$_SERVER['REQUEST_URI']=$_SERVER['SCRIPT_NAME'];
			$_SERVER['SCRIPT_FILENAME']=$cwd . DIRECTORY_SEPARATOR . 'htdocs' . DIRECTORY_SEPARATOR . 'index.php';
